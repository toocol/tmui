...
impl Into<KeyCode> for VirtualKeyCode {
    fn into(self) -> KeyCode {
        match self {
            Self::Key1 => KeyCode::Key1,
            Self::Key2 => KeyCode::Key2,
            Self::Key3 => KeyCode::Key3,
            Self::Key4 => KeyCode::Key4,
            Self::Key5 => KeyCode::Key5,
            Self::Key6 => KeyCode::Key6,
            Self::Key7 => KeyCode::Key7,
            Self::Key8 => KeyCode::Key8,
            Self::Key9 => KeyCode::Key9,
            Self::Key0 => KeyCode::Key0,
            Self::A => KeyCode::KeyA,
            Self::B => KeyCode::KeyB,
            Self::C => KeyCode::KeyC,
            Self::D => KeyCode::KeyD,
            ...
            Self::Snapshot => KeyCode::KeyPrint,
            Self::Scroll => KeyCode::KeyScrollLock,
            Self::Pause => KeyCode::KeyPause,
            Self::Insert => KeyCode::KeyInsert,
            Self::Home => KeyCode::KeyHome,
            Self::Delete => KeyCode::KeyDelete,
            Self::End => KeyCode::KeyEnd,
            Self::PageDown => KeyCode::KeyPageDown,
            Self::PageUp => KeyCode::KeyPageUp,
            Self::Left => KeyCode::KeyLeft,
            Self::Up => KeyCode::KeyUp,
            Self::Right => KeyCode::KeyRight,
            Self::Down => KeyCode::KeyDown,
            Self::Back => KeyCode::KeyBackspace,
            Self::Return => KeyCode::KeyEnter,
            Self::Space => KeyCode::KeySpace,
            Self::Compose => KeyCode::KeyCompose,
            Self::Caret => KeyCode::KeyCaret,
            ...
            Self::NumpadEquals => KeyCode::KeyNumpadEquals,
            Self::NumpadMultiply => KeyCode::KeyNumpadMultiply,
            Self::NumpadSubtract => KeyCode::KeyNumpadSubtract,
            Self::AbntC1 => KeyCode::KeyAbntC1,
            Self::AbntC2 => KeyCode::KeyAbntC2,
            Self::Apostrophe => KeyCode::KeyApostrophe,
            Self::Apps => KeyCode::KeyMenu,
            Self::Asterisk => KeyCode::KeyAsterisk,
            Self::At => KeyCode::KeyAt,
            Self::Ax => unimplemented!(),
            Self::Backslash => KeyCode::KeyBackslash,
            Self::Calculator => KeyCode::KeyCalculator,
            Self::Capital => KeyCode::KeyCapsLock,
            Self::Colon => KeyCode::KeyColon,
            Self::Comma => KeyCode::KeyComma,
            Self::Convert => unimplemented!(),
            Self::Equals => KeyCode::KeyEqual,
            Self::Grave => KeyCode::KeyTilde,
            Self::Kana => KeyCode::KeyKana,
            Self::Kanji => KeyCode::KeyKanji,
            Self::LAlt => KeyCode::KeyAlt,
            Self::LBracket => KeyCode::KeyBracketLeft,
            Self::LControl => KeyCode::KeyControl,
            Self::LShift => KeyCode::KeyShift,
            Self::LWin => KeyCode::KeyMeta,
            Self::Mail => KeyCode::KeyMail,
            Self::MediaSelect => KeyCode::KeyMediaSelect,
            Self::MediaStop => KeyCode::KeyMediaStop,
            Self::Minus => KeyCode::KeyMinus,
            Self::Mute => KeyCode::KeyMute,
            Self::MyComputer => unimplemented!(),
            Self::NavigateForward => unimplemented!(),
            Self::NavigateBackward => unimplemented!(),
            Self::NextTrack => unimplemented!(),
            Self::NoConvert => unimplemented!(),
            Self::OEM102 => unimplemented!(),
            Self::Period => KeyCode::KeyPeriod,
            Self::PlayPause => unimplemented!(),
            Self::Plus => KeyCode::KeyPlus,
            Self::Power => unimplemented!(),
            Self::PrevTrack => unimplemented!(),
            Self::RAlt => KeyCode::KeyAlt,
            Self::RBracket => KeyCode::KeyBracketRight,
            Self::RControl => KeyCode::KeyControl,
            Self::RShift => KeyCode::KeyShift,
            Self::RWin => KeyCode::KeyMeta,
            Self::Semicolon => KeyCode::KeySemicolon,
            Self::Slash => KeyCode::KeySlash,
            Self::Sleep => unimplemented!(),
            Self::Stop => unimplemented!(),
            Self::Sysrq => KeyCode::KeySysReq,
            Self::Tab => KeyCode::KeyTab,
            Self::Underline => KeyCode::KeyUnderLine,
            Self::Unlabeled => unimplemented!(),
            Self::VolumeDown => KeyCode::KeyVolumeDown,
            Self::VolumeUp => KeyCode::KeyVolumeUp,
            Self::Wake => unimplemented!(),
            Self::WebBack => unimplemented!(),
            Self::WebFavorites => unimplemented!(),
            Self::WebForward => unimplemented!(),
            Self::WebHome => unimplemented!(),
            Self::WebRefresh => unimplemented!(),
            Self::WebSearch => unimplemented!(),
            Self::WebStop => unimplemented!(),
            Self::Yen => unimplemented!(),
            Self::Copy => unimplemented!(),
            Self::Paste => unimplemented!(),
            Self::Cut => unimplemented!(),
        }
    }
}
