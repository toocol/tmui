...
impl Into<KeyCode> for winit::keyboard::KeyCode {
    fn into(self) -> KeyCode {
        match self {
            ...
            Self::Backspace => KeyCode::KeyBackspace,
...
impl Into<CursorIcon> for SystemCursorShape {
    fn into(self) -> CursorIcon {
        match self {
            ...
            Self::SizeVerCursor => CursorIcon::NsResize,
            Self::SizeHorCursor => CursorIcon::EwResize,
            Self::SizeBDiagCursor => CursorIcon::NeswResize,
            Self::SizeFDiagCursor => CursorIcon::NwseResize,
            ...
            Self::GrabCursor => CursorIcon::Grab,
            Self::GrabbingCursor => CursorIcon::Grabbing,
